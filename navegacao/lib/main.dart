          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                // Push - empurra uma nova rota, para a pilha de navageção. 
                Navigator.push(
                  // Context identifica a página atual.
                  context,
                  // MaterialPageRoute - define animação e layout para ir a outra tela.
                  // Builder - Constró a nova tela Pagina2.
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              const Text(
                'É uma linguagem versátil que combina eficiência e com desempenho.',
                style: TextStyle(fontSize: 30),
              ),
...
// Stalles - Informações estáticas, não mudam.
class Pagina3 extends StatelessWidget{
  // Build - responsável pela renderização/construção.
  @override
  Widget build(BuildContext context) {
    // Define estrutura de layout - appbar + body.
    return Scaffold(
      appBar: AppBar(
        title: Text('Página 3'),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.network('https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Senac_logo.svg/2560px-Senac_logo.svg.png', width: 300, height: 300,),
          ],
        ),
      ),
    );
